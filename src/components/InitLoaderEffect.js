...
export default function InitLoaderEffect({ route }) {
    ...
    try {
      ...
      if (token == null || token == undefined) navigation.navigate("LoginPage");
        ...
        if (data.status !== "true") navigation.navigate("LoginPage");
          ...
          await axios
            ...
            .then(async (res) => {
              if (res.data.status === "0") {
                ...
                finalDetails.booking_link =
                  res.data.booking_link != (null || undefined)
                    ? res.data.booking_link
                    : "https://heartitout.in/therapists/";
              } else {
            ...
            .then(async (res) => {
              if (res.data.status === "1") {
                (finalDetails.has_banner = res.data.has_banner),
                  ...
                  (finalDetails.on_click =
                    res.data.ban_on_click != (null || undefined)
                      ? res.data.ban_on_click
                      : "https://heartitout.in/"),
                  (finalDetails.has_mood =
                    res.data.mood_tacker != (null || undefined)
                      ? res.data.mood_tacker
                      : "no");
                ...
                finalDetails.booking_link =
                  res.data.booking_link != (null || undefined)
                    ? res.data.booking_link
                    : "https://heartitout.in/therapists/";
                finalDetails.whats_new_onclick =
                  res.data.whats_new_onclick != (null || undefined)
                    ? res.data.whats_new_onclick
                    : "https://heartitout.in/";
                finalDetails.product_onclick =
                  res.data.product_onclick != (null || undefined)
                    ? res.data.product_onclick
                    : "https://heartitout.in/";
                finalDetails.sub_onclick =
                  res.data.sub_onclick != (null || undefined)
                    ? res.data.sub_onclick
                    : "https://heartitout.in/";
                finalDetails.packages_onclick =
                  res.data.packages_onclick != (null || undefined)
                    ? res.data.packages_onclick
                    : "https://heartitout.in/";
                finalDetails.welbeing_onclick =
                  res.data.welbeing_onclick != (null || undefined)
                    ? res.data.welbeing_onclick
                    : "https://mindbodybliss.in/";
                finalDetails.whatsapp_onclick =
                  res.data.whatsapp_onclick != (null || undefined)
                    ? res.data.whatsapp_onclick
                    : "https://www.whatsapp.com";
                setUser({
                  category: res.data.user_category,
          ...
          const apiUrl4 = "https://n8n.heartitout.in/webhook/api/discover_meta";
          await axios
            .post(apiUrl4, userDetails)
            .then(async (res) => {
              console.log("It is for discover: ", res.data);
              finalDetails.mindfull =
                res.data.data[0] != (null || undefined)
                  ? res.data.data[0].on_click
                  : "https://www.heartitout.in";
              finalDetails.holistic =
                res.data.data[1] != (null || undefined)
                  ? res.data.data[1].on_click
                  : "https://www.heartitout.in";
              finalDetails.selfcare =
                res.data.data[2] != (null || undefined)
                  ? res.data.data[2].on_click
                  : "https://www.heartitout.in";
            })
            .catch((err) => {
              console.log(err);
  ...
  return (
    <SafeAreaView className="bg-white" style={{ height: hp(100) }}>
      ...
      >
        <Text style={{ fontSize: wp(5.2), width:wp(100), 
        fontWeight:'500',
        textAlign:'center',
        color:theme.black
        }}>
      ...
      <Image
        ...
        resizeMode="contain"
        style={{ height: hp(70.44), width: wp(100), 
          // marginTop: hp(18) 
          position:'absolute',
          bottom:0,
        }}
