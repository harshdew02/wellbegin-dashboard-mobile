        ...
        <SafeAreaView>
            ...
            <ScrollView style={{ backgroundColor: '#fff', height: hp(100) }} >
                ...
                <View style={[styles.cardContiner, { marginTop: hp(2) }]}>
                    <View className="flex-row justify-between " style={{ height: hp(25) }}>
                        <TouchableOpacity style={[styles.packageCard, { width: wp(39), backgroundColor: 'rgba(210, 184, 157, 0.15)' }]}>
                            <SeekIcon width={wp(25)} height={hp(10)} />
                            <Text style={[styles.cardText, { color: '#4D4C4C' }]}>
                                Seek Advanced Care
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.packageCard, { width: wp(39), backgroundColor: '#EAF7FC' }]}>
                    ...
                    <View className="flex-row justify-between " style={{ height: hp(25), marginTop: hp(3), }}>
                        <TouchableOpacity style={[styles.packageCard, { width: wp(39), backgroundColor: 'rgba(4, 84, 123, 0.08)' }]}>
                            <ExploreIcon width={wp(20)} height={hp(11)} />
                            <Text style={[styles.cardText, { color: '#455A64' }]}>
                                Explore Diagnostics
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.packageCard, { width: wp(39), backgroundColor: 'rgba(247, 207, 106, 0.20)' }]}>
                            <ProductsSvg width={wp(33)} height={hp(9)} />
                            <Text style={[styles.cardText, { marginBottom: hp(2), color: '#765A5A' }]}>
                                New Products
                            </Text>
                        </TouchableOpacity>
                    </View>
                ...
                <TouchableOpacity style={[styles.cardContiner, { height: hp(16) }]}>
                    ...
                    <View className="flex-row items-center justify-between" style={{ position: 'absolute', zIndex: 1, width: '100%', height: '100%', left: wp(8), right: wp(8), paddingHorizontal: wp(12) }} >
                ...
                <View className="flex-row items-center" style={[styles.cardContiner, { height: hp(20), marginTop: hp(3), backgroundColor: '#EBEFF2CC' }]}>
...
const styles = StyleSheet.create({
    ...
    cardText: {
        textAlign: 'center', fontSize: wp(4), fontFamily: 'Roboto', fontWeight: '800'
    },
    ...
    packageCard: {
        width: wp(40), height: '100%', borderRadius: wp(4),
