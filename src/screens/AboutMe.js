import { View, Text, SafeAreaView, Image, StyleSheet, TouchableOpacity, Button, TextComponent, useWindowDimensions, TextInput } from 'react-native'
  ...
  return (
    <SafeAreaView>
      <ScrollView style={{ backgroundColor: '#fff', height: hp(100) }} >
        <View style={[styles.cardContainer, { height: hp(66), backgroundColor: '#32959d' }]}>
          <View
            style={{
              // backgroundColor: "#fff",
              height: hp(6),
          ...
          <View className="flex-col justify-between items-center " style={{ height: hp(32), marginTop: hp(3.5) }} >
